...
var assignFalseAndTruePositives_1 = require("./assignFalseAndTruePositives");
/**
 ...
 * @returns AP
 */
function averagePrecision(inputs, iouThreshold) {
    ...
    var numIntervals = 11;
    var precisionsForRecallInterval = utils_1.range(numIntervals, 0, 0.1).map(function (recallThreshold) {
...
function categorizeBoxes(input, iouThreshold) {
    var _a = assignFalseAndTruePositives_1.assignFalseAndTruePositives(input.groundTruth, input.predictions, iouThreshold), truePositives = _a.truePositives, falsePositives = _a.falsePositives;
