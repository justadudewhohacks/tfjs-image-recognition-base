...
var LabeledBox_1 = require("../classes/LabeledBox");
var PredictedBox_1 = require("../classes/PredictedBox");
var averagePrecision_1 = require("./averagePrecision");
/**
 ...
 * @returns mAP
 */
function meanAveragePrecision(inputs, iouThreshold, classScoreThreshold) {
    ...
    inputs.forEach(function (input) {
        input.groundTruth.forEach(function (box) {
            if (!(box instanceof LabeledBox_1.LabeledBox)) {
        ...
        input.predictions.forEach(function (box) {
            if (!(box instanceof PredictedBox_1.PredictedBox)) {
    ...
    var averagePrecisionsByClass = inputsByClass.map(function (_a) {
        ...
        return tslib_1.__assign({ classLabel: classLabel }, averagePrecision_1.averagePrecision(inputs, iouThreshold));
    });
    return {
...
exports.meanAveragePrecision = meanAveragePrecision;
