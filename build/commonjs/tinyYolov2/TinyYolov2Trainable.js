...
var TinyYolov2Trainable = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        reshapedImgDims = index_1.computeReshapedDimensions(dom_1.getMediaDimensions(img), inputSize);
                        ...
                        return [4 /*yield*/, dom_1.toNetInput(dom_1.imageToSquare(img, inputSize))];
                    case 1:
                        netInput = _b.sent();
    ...
    TinyYolov2Trainable.prototype.filterGroundTruthBoxes = function (groundTruth, imgDims, minBoxSize) {
        ...
        return groundTruth.filter(function (_a) {
            ...
            var box = new classes_1.Rect(x, y, width, height).rescale({
                height: imgHeight,
                width: imgWidth
            });
